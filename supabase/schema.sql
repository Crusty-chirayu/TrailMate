-- TrailMate database schema — Phase 12A security baseline.
--
-- This file is a readable snapshot of the schema produced by the authoritative
-- files in supabase/migrations/. For a fresh project, run migrations in version
-- order. Do not apply this snapshot on top of an existing database.
